...
export interface BaseSelectProps {
  ...
  onChange?(value: ValueType<InputOption, false>, actionMeta?: ActionMeta<InputOption>): void;
  options: InputOption[];
  placeholder?: string;
  searchable?: boolean;
...
interface ComponentProps extends BaseSelectProps {
  ...
  formatOptionLabel?(option: InputOption, labelMeta: FormatOptionLabelMeta<InputOption, false>): ReactNode;
}
