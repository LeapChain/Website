  ...
  return (
    <DocContainer className="Resource" title="Bounty Account Refills">
      ...
      <p>
        ...
        issue in the <A href="https://github.com/LeapChain/Contributor-Payments">Contributor-Payments</A> repository.
        When the majority of auditors approve the request (after verifying that all previous funds have been used
