...
const HomeHero: FC = () => {
  ...
  return (
    <S.Container>
      <S.Heading>
        <S.HeadingSegment>The next</S.HeadingSegment> <S.HeadingSegment highlighted>LEAP</S.HeadingSegment>{' '}
        <S.HeadingSegment>for crypto.</S.HeadingSegment>
      </S.Heading>
      <S.Paragraph>
        We are in development. Stay tuned in Discord for updates and contribute to polls to make a difference.
      </S.Paragraph>
      <S.Actions>
